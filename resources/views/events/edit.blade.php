                ...
                <form action="/events/update/{{ $advert->id }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div class="input-group input-group-lg mb-1 mt-1">
                            <input type="text" class="form-control" id="title" name="title"
                                placeholder="Digite aqui o nome do seu anuncio" value="{{ $advert->title }}">
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group input-group-lg mb-1 mt-1">
                            <select class="form-control" name="category" id="category">
                                <option value="categoria1" {{ $advert->category === 'categoria1' ? 'selected' : '' }}>Free
                                    Fire</option>
                                <option value="categoria2" {{ $advert->category === 'categoria2' ? 'selected' : '' }}>Clash
                                    of Clans</option>
                                <option value="categoria3" {{ $advert->category === 'categoria3' ? 'selected' : '' }}>Call
                                    of Duty</option>
                                <option value="categoria4" {{ $advert->category === 'categoria4' ? 'selected' : '' }}>Fifa
                                    23</option>
                                <option value="categoriaOutros"
                                    {{ $advert->category === 'categoriaOutros' ? 'selected' : '' }}>Outros</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="input-group input-group-lg mb-1 mt-1">
                            ...
                            <img style="width: 100%" src="/img/announcement/{{ $advert->image }}"
                                alt="{{ $advert->title }}">
                        </div>
